      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <Image
            ...
            height={100}
            priority
            className="h-[70px] w-auto md:h-[90px] mx-auto mb-6 object-contain"
          />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/get-involved"
              className="bg-green-700 hover:bg-green-800 text-white px-6 py-3 rounded font-bold transition-colors duration-200"
            >
              Get Involved
            </Link>
            <Link
    ...
    <section className="bg-hero-gradient py-16 sm:py-20 md:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        <Image
          ...
          height={80}
          priority
          className="h-[50px] w-auto md:h-[70px] mx-auto mb-6 object-contain"
        />
